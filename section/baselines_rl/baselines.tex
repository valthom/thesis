...
\begin{itemize}
    ...
    \item Collaborated with Wesley on the divergence proofs for the 3 arms setting
    \item Designed the simplex visualizations (\Cref{fig:trajectories} and \Cref{fig:simplex_variance})
