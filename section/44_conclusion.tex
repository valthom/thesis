...
% While we have analyzed the role of noise, 
...
\item While in this thesis we have mostly been concerned with policy
        ...
        % important of the matrix $\rmP^\pi$, I would like
        % to understand more precisely how the structure of the environment can
        % impact how efficient learning a value function can be. One approach
        % related to our recent work CITE
