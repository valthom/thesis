...
% In planning, an agent uses a model of the environment, either learned or provided, to simulate potential state transitions and rewards, thereby constructing a new policy  or improving the current one for better decision-making.
